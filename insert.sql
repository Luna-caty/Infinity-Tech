INSERT INTO Laptops (id_pc, name, marque, cpu, gpu, ram, stockage, ecran, batterie, design, systeme_exploitation, poids, description, prix, quantite_stock, image_principale) 
VALUES 
(1,  'Dell XPS 15', 'Dell', 'Intel Core i7-12700H', 'NVIDIA RTX 3050 Ti', '16GB DDR5', '512GB SSD', '15.6" 4K OLED', '86Wh', 'Aluminium', 'Windows 11', '1.9kg', 
...
(2,'MacBook Pro 16', 'Apple', 'Apple M2 Max', NULL, '32GB Unified', '1TB SSD', '16.2" Retina', '100Wh', 'Aluminium', 'macOS Ventura', '2.1kg', 
...
(3,'Asus ROG Strix G15', 'Asus', 'AMD Ryzen 9 6900HX', 'NVIDIA RTX 3070 Ti', '32GB DDR5', '1TB SSD', '15.6" 300Hz FHD', '90Wh', 'Plastique renforcé', 'Windows 11', '2.4kg', 
...
(4,'HP Spectre x360', 'HP', 'Intel Core i7-1255U', 'Intel Iris Xe', '16GB LPDDR4x', '512GB SSD', '13.5" OLED', '66Wh', 'Aluminium', 'Windows 11', '1.3kg', 
...
(5,'Lenovo ThinkPad X1 Carbon', 'Lenovo', 'Intel Core i7-1280P', 'Intel Iris Xe', '16GB LPDDR5', '512GB SSD', '14" 2.2K IPS', '57Wh', 'Carbone et magnésium', 'Windows 11', '1.1kg', 
...
-- table smartphones
INSERT INTO Smartphones (id_phone,name, marque, processeur, ecran, ram, stockage, appareil_photo, batterie, securite, design, dimensions, poids, description, prix, quantite_stock, image_principale) 
VALUES 
(1,'iPhone 15 Pro Max', 'Apple', 'Apple A17 Pro', '6.7" Super Retina XDR OLED', '8GB', '256GB', '48MP + 12MP + 12MP', '4323mAh', 'Face ID', 'Titane', '159.9 x 76.7 x 8.3 mm', '221g', 
...
(2, 'Samsung Galaxy S23 Ultra', 'Samsung', 'Snapdragon 8 Gen 2', '6.8" Dynamic AMOLED 2X', '12GB', '512GB', '200MP + 12MP + 10MP + 10MP', '5000mAh', 'Empreinte digitale (sous écran)', 'Aluminium et verre', '163.4 x 78.1 x 8.9 mm', '234g', 
...
(3,'Google Pixel 8 Pro', 'Google', 'Google Tensor G3', '6.7" LTPO OLED', '12GB', '256GB', '50MP + 48MP + 12MP', '5050mAh', 'Empreinte digitale & Face Unlock', 'Aluminium et verre', '162.6 x 76.5 x 8.7 mm', '213g', 
...
(4,'Sony Xperia 1 V', 'Sony', 'Snapdragon 8 Gen 2', '6.5" 4K OLED 120Hz', '12GB', '256GB', '48MP + 12MP + 12MP', '5000mAh', 'Empreinte digitale (latérale)', 'Verre Gorilla Glass Victus', '165 x 71 x 8.3 mm', '187g', 
...
(5,'Xiaomi 13 Pro', 'Xiaomi', 'Snapdragon 8 Gen 2', '6.73" AMOLED LTPO 120Hz', '12GB', '512GB', '50MP + 50MP + 50MP', '4820mAh', 'Empreinte digitale sous écran', 'Verre céramique', '162.9 x 74.6 x 8.4 mm', '210g', 
...
-- table accessoires
INSERT INTO Accessoires (id_accessoire,  name, marque, type_accessoire, specifications, compatibilite, description, prix, quantite_stock, image_principale) 
VALUES 
(1,  'Clavier Mécanique RGB', 'Corsair', 'Clavier', 'Switches Cherry MX Red, RGB personnalisable, USB-C', 'Windows, macOS', 
...
(2, 'Souris Gaming Logitech G502', 'Logitech', 'Souris', 'Capteur HERO 25K, 11 boutons programmables, RGB', 'Windows, macOS', 
...
(3,'Casque Gamer HyperX Cloud II', 'HyperX', 'Casque', 'Son surround 7.1, micro amovible, USB et jack 3.5mm', 'PC, PS5, Xbox, Switch', 
...
(4, 'Webcam Logitech C920', 'Logitech', 'Webcam', 'Résolution 1080p, Autofocus, Micro stéréo', 'Windows, macOS', 
...
INSERT INTO Stockage_Composants (id_composant,  name, marque, type_composant, capacite, specifications, compatibilite, description, prix, quantite_stock, image_principale) 
VALUES 
(3,'NVIDIA RTX 4070 Ti', 'NVIDIA', 'Carte Graphique', NULL, '12GB GDDR6X, Ray Tracing, DLSS 3.0, PCIe 4.0', 'Compatible avec cartes mères PCIe 4.0', 
...
(4,'Intel Core i9-13900K', 'Intel', 'Processeur', NULL, '24 cœurs, 32 threads, 5.8 GHz, LGA 1700, 125W TDP', 'Compatible cartes mères LGA 1700', 
...
(5,'Corsair Vengeance RGB 32GB', 'Corsair', 'RAM', '32GB (2x16GB)', 'DDR5, 6000 MHz, Latence CL36, dissipateur thermique RGB', 'Compatible DDR5', 
...
(6,'ASUS ROG Strix Z790-E', 'ASUS', 'Carte Mère', NULL, 'Wi-Fi 6E, PCIe 5.0, USB 3.2 Gen2, ATX', 'Compatible Intel 12e et 13e Gen', 
...
(7,'Corsair RM850x 80+ Gold', 'Corsair', 'Alimentation', '850W', 'Full modulaire, certification 80+ Gold, refroidissement silencieux', 'Compatible ATX/M-ATX', 
...
(8,'NZXT H510 Elite', 'NZXT', 'Boîtier', NULL, 'Panneau en verre trempé, gestion des câbles optimisée, ventilation RGB incluse', 'Compatible ATX, M-ATX, ITX', 
...
(9,'Noctua NH-D15', 'Noctua', 'Ventilateur', NULL, 'Double tour, 2 ventilateurs 140mm, 1500 RPM', 'Compatible Intel & AMD', 
 'Un des meilleurs ventirads du marché, assurant un refroidissement performant et silencieux.', 
 99.99, 14, 'noctua_nh_d15.png'),

(10,'Corsair iCUE H150i Elite', 'Corsair', 'Watercooling', NULL, 'Radiateur 360mm, pompe silencieuse, éclairage RGB', 'Compatible Intel & AMD', 
